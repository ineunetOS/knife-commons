/*
 * Licensed to the Apache Software Foundation (ASF) and iNeunet OpenSource under one or more
...
public abstract class StringUtils {
    ...
    public static boolean equalsTrimed(String s1, String s2) {
